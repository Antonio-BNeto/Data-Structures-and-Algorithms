...
public class Util {
	...
	public static <T extends Comparable<T>> BSTNode<T> doubleLeftRotation(BSTNode<T> currentNode){
		rightRotation((BSTNode<T>) currentNode.getRight());
		return leftRotation(currentNode);
	}

	public static <T extends Comparable<T>> BSTNode<T> doubleRightRotation(BSTNode<T> currentNode){
		leftRotation((BSTNode<T>)currentNode.getLeft());
